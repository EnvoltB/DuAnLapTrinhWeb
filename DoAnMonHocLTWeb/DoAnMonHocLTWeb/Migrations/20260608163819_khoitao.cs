    ...
    public partial class khoitao : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                table: "Categories",
                columns: new[] { "Id", "Description", "DisplayOrder", "IconClass", "ImageUrl", "Name", "ShowOnHomepage", "Slug" },
                values: new object[,]
                {
                    { 1, "Ultra-light gaming mice with high-precision sensors for competitive gaming", 1, "fa-solid fa-computer-mouse", "/images/categories/mice-category.jpg", "Gaming Mice", true, "gaming-mice" },
                    { 2, "Hall effect and mechanical keyboards for pro-level performance", 2, "fa-solid fa-keyboard", "/images/categories/keyboard-category.jpg", "Gaming Keyboards", true, "gaming-keyboards" }
                });

            migrationBuilder.InsertData(
                table: "Products",
                columns: new[] { "Id", "Brand", "CategoryId", "Color", "ComparePrice", "CreatedAt", "Description", "GalleryImages", "IsBestSeller", "IsFeatured", "IsNew", "MainImageUrl", "Name", "Price", "ShortDescription", "Slug", "Specifications", "StockQuantity", "UpdatedAt", "Weight" },
                values: new object[,]
                {
                    { 1, "ATK GEAR", 1, "Frosted White", 3990000m, new DateTime(2026, 6, 8, 16, 38, 19, 1, DateTimeKind.Utc).AddTicks(5354), "The ATK Blazing Sky ZERO redefines lightweight gaming performance:\r\n                <ul>\r\n                    <li>Ultra-light at just 39g with solid holeless frosted translucent shell</li>\r\n                    <li>Dual 8K wireless connectivity</li>\r\n                    <li>Flagship PAW3950 Ultra sensor for high-precision tracking</li>\r\n                    <li>Nordic 54 series chip for ultra-low latency</li>\r\n                    <li>Nano coating for stable, comfortable grip</li>\r\n                    <li>Built for competitive gaming</li>\r\n                </ul>", "/images/products/atk-zero-1.png,/images/products/atk-zero-2.png", true, true, true, "/images/products/atk-blazing-sky-zero.webp", "ATK Blazing Sky ZERO", 2990000m, "Ultra-light 39g wireless gaming mouse with PAW3950 sensor", "atk-blazing-sky-zero", "{\"Sensor\":\"PAW3950 Ultra\",\"Connectivity\":\"Dual 8K Wireless\",\"Battery Life\":\"80 hours\",\"Switch\":\"Optical\",\"DPI\":\"26000\"}", 50, null, 39 },
                    { 2, "ATK GEAR", 2, "Black", 5890000m, new DateTime(2026, 6, 8, 16, 38, 19, 1, DateTimeKind.Utc).AddTicks(5400), "The ATK RS6 Hall Effect Keyboard delivers unparalleled gaming performance:\r\n                <ul>\r\n                    <li>Hall Effect magnetic switches for ultra-fast response</li>\r\n                    <li>Co-developed with VALORANT pro player Aspas</li>\r\n                    <li>Adjustable actuation points (0.1mm - 4.0mm)</li>\r\n                    <li>Rapid Trigger technology</li>\r\n                    <li>RGB backlighting with customizable effects</li>\r\n                    <li>PBT double-shot keycaps</li>\r\n                    <li>Hot-swappable PCB</li>\r\n                </ul>", "/images/products/atk-rs6-1.png,/images/products/atk-rs6-2.png", true, true, true, "/images/products/atk-rs6-keyboard.png", "ATK RS6 Hall Effect Keyboard", 4590000m, "Co-Developed with Pro Player Aspas - Extreme Performance Gaming Keyboard", "atk-rs6-hall-effect", "{\"Switch Type\":\"Hall Effect Magnetic\",\"Keycaps\":\"PBT Double-shot\",\"Connectivity\":\"Wired USB-C\",\"Polling Rate\":\"8000Hz\",\"Actuation\":\"Adjustable 0.1-4.0mm\",\"Form Factor\":\"75%\"}", 35, null, 850 }
                });
